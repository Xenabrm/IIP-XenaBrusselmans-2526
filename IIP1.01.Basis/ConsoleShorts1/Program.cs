...
namespace ConsoleShorts01
{
    class Program
    {
        static void Main(string[] args)
        {
             ...
             */
            Console.WriteLine("\n\nOefening A.1: één tekstregel afdrukken\n------------\n");
			string boodschap = "Welkome in de wereld van C#!";
...
Geslacht: {geslacht}");
			...
			int bonus = 7;
			Console.WriteLine($"Bonus: {punten}");
			int totaal = punten + bonus;
		    Console.WriteLine($"Je totale punten: {totaal}");
            ...
            Console.WriteLine("\n\nOefening D.1: escaping - aanhalingstekens\n------------\n");
            // TODO: implementeer hier.
			Console.WriteLine("Hij zij: \"Hallo Wereld!\"");
...
Copyright ©️2024");
            ...
            // TODO: implementeer hier.
			 ...
			 Console.WriteLine("systeem wordt over 5 minuten herstart.");
             Console.ResetColor();
			 Console.WriteLine();
